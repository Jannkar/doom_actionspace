...
class DQN(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.1,
                 ...
                 _init_setup_model=True, policy_kwargs=None, freeze_base_nn = False, freeze_vf = False, freeze_last_fc = False):
        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                self.act, self._train_step, self.update_target, self.step_model = deepq.build_train(
                    ...
                    sess=self.sess,
                    freeze_base_nn = self.freeze_base_nn, 
                    freeze_vf = self.freeze_vf,
                    freeze_last_fc = self.freeze_last_fc
                )
                self.proba_step = self.step_model.proba_step
                self.params = find_trainable_variables("deepq") #self.params
